...
Tile::Tile(int numTle, int spaceOcupedX, int spaceOcupedY) : numProprietieTile{numTle},
                                                             spaceOcuped{sf::Vector2f(spaceOcupedX, spaceOcupedY)}
{
    if (numTle != 0)
    {
        tileSprite.setTexture(*(tileManager.getTileTexture(numTle, rectTile, sf::Vector2f(spaceOcupedX, spaceOcupedY))));
